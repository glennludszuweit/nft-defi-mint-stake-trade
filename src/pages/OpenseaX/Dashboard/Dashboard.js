                    ...
                    <TableCell className={classes.cell}>
                      ...
                      new Date(asset.sell_orders[0]?.closing_date) >
                        ...
                        <span className={classes.currencyContainer}>
                          ...
                          />
                          <span>
                            {formatTokenAmount(asset.sell_orders[0].base_price)}
                          </span>
                        </span>
                      ) : (
                        ""
                    ...
                    <TableCell className={classes.cell}>
                      ...
                      new Date(asset.orders[0]?.closing_date) > Date.now() ? (
                        <span className={classes.currencyContainer}>
                          ...
                          />
                          <span>
                            {formatTokenAmount(asset.orders[0].base_price)}
                          </span>
                        </span>
                      ) : (
                        ""
                    ...
                    <TableCell className={classes.cell}>
                      {asset?.last_sale?.total_price && (
                        <span className={classes.currencyContainer}>
                          ...
                          />
                          <span>
                            {formatTokenAmount(asset.last_sale.total_price)}
                          </span>
                        </span>
                      )}
                    </TableCell>
                        ...
                        <span className={classes.currencyContainer}>
                          ...
                          <span>
                            {activity.event_type === "successful"
                              ? formatTokenAmount(activity.total_price)
                              : activity.event_type === "offer_entered"
                              ? formatTokenAmount(activity.bid_amount)
                              : null}
                          </span>
                        </span>
                      }
